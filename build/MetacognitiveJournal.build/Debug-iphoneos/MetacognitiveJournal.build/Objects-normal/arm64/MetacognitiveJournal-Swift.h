...
#ifndef METACOGNITIVEJOURNAL_SWIFT_H
#define METACOGNITIVEJOURNAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetacognitiveJournal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIWindow;
@class UIApplication;
SWIFT_CLASS("_TtC20MetacognitiveJournal11AppDelegate")
...
SWIFT_CLASS("_TtC20MetacognitiveJournal12AudioService")
@interface AudioService : NSObject <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC20MetacognitiveJournal13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC20MetacognitiveJournal29TamperResistantViewController")
@interface TamperResistantViewController : UIViewController
- (void)viewDidLoad;
...
@class UITextField;
@class UIButton;
SWIFT_CLASS("_TtC20MetacognitiveJournal25SecureLoginViewController")
@interface SecureLoginViewController : TamperResistantViewController
...
SWIFT_CLASS("_TtC20MetacognitiveJournal16SpeechRecognizer")
...
SWIFT_CLASS("_TtC20MetacognitiveJournal24VoiceJournalAudioManager")
@interface VoiceJournalAudioManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
